...
@Entity
@Table(name = "tahsilat2", schema = "public")
public class Tahsilat2 implements java.io.Serializable {
	private static final long serialVersionUID = 4418029727139184238L;

	@Id
	@Column(name = "id")
	@SequenceGenerator(name = "tabloSequnce", sequenceName = "tahsilat2_id_seq")
