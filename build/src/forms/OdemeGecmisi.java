...
@Entity
@Table(name = "odemegecmisi", schema = "public")
public class OdemeGecmisi implements java.io.Serializable {
	private static final long serialVersionUID = 4418029727139184238L;

	@Id
	@Column(name = "id")
	@SequenceGenerator(name = "tabloSequnce", sequenceName = "odemegecmisi_id_seq")
