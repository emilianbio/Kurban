...
<body onload="bolme()" onmousemove="bolme()">
<jsp:include page="/WEB-INF/jsp/ustbaslik.jsp" />
	...
	<form:form method="post" action="ekleSatis" commandName="hissedar" >
		<form:hidden path="id" />
		<table style="">
			<tr>
				<td>Hayvan No</td>
				<td><form:input path="hayvanNo" required="true" id="hayvanNo"
						readonly="true" /></td>
			</tr>
			<tr>
				<td>Satış Fiyatı</td>
			...
			<tr>
				<td>Kesim Fiyatı</td>
				<td><input name="kesimUcreti" id="kesimFiyati" value="300" /></td>
			</tr>
			<tr>
				<td>Kesim Sırası</td>
		...
		<table id="giristablosu" border="1" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<input type="button" value="VAZGEÇ"	style="width: 20em; height: 5em" onclick="javascript:location.href='./hissedarVazgec'" />
				<input type="button" value="EKLE" onclick="kontrol2()" style="width: 20em; height: 5em"></td>
			</tr>
	...
	<table border="2" cellpadding="0" cellspacing="0" id="satistablosu"
		...
		<c:forEach items="${list}" var="hissedar" varStatus="sira">
			...
			<tr id="satirno${hissedar.id}">
				<td>${sira.count}</td>
				<td class="tablosatir"><a href="./hissedarGetir/${hissedar.id}">
